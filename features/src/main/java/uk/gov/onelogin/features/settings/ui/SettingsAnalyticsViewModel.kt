...
class SettingsAnalyticsViewModel
    @Inject
    constructor(
        ...
        companion object {
            ...
            internal fun makeSettingsViewEvent(context: Context) =
                with(context) {
                    ViewEvent.Screen(
            ...
            internal fun makeSignInDetailsEvent(context: Context) =
                with(context) {
                    TrackEvent.Link(
                        isExternal = false,
            ...
            internal fun makeUsingOneLoginEvent(context: Context) =
                with(context) {
                    TrackEvent.Link(
                        isExternal = false,
            ...
            internal fun makeContactEvent(context: Context) =
                with(context) {
                    TrackEvent.Link(
                        isExternal = false,
            ...
            internal fun makePrivacyNoticeEvent(context: Context) =
                with(context) {
                    TrackEvent.Link(
                        isExternal = false,
            ...
            internal fun makeAccessibilityEvent(context: Context) =
                with(context) {
                    TrackEvent.Link(
                        isExternal = false,
            ...
            internal fun makeOpenSourceEvent(context: Context) =
                with(context) {
                    TrackEvent.Button(
            ...
            internal fun makeSignOutEvent(context: Context) =
                with(context) {
                    TrackEvent.Button(
            ...
            internal fun makeBiometricsButtonEvent(context: Context) =
                with(context) {
                    TrackEvent.Button(
            ...
            internal fun makeAddDocumentsEvent(context: Context) =
                with(context) {
                    TrackEvent.Link(
                        isExternal = false,
            ...
            internal fun makeTermsAndConditionsEvent(context: Context) =
                with(context) {
                    TrackEvent.Link(
                        isExternal = false,
