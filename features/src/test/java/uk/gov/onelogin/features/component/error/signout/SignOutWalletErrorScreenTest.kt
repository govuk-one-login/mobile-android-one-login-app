package uk.gov.onelogin.features.component.error.signout
...
import uk.gov.onelogin.features.error.ui.signout.SignOutErrorViewModel
...
class SignOutWalletErrorScreenTest : FragmentActivityTestCase() {
    ...
    fun clickExitButton() {
        ...
        verify(navigator, Mockito.times(2)).goBack()
    }
