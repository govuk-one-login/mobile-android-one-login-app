package uk.gov.onelogin.features.unit.error.ui.generic
...
import uk.gov.onelogin.features.error.ui.generic.GenericErrorPreview

@RunWith(Parameterized::class)
class GenericErrScreenshotTest(
    nightMode: NightMode
