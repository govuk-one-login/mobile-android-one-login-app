package uk.gov.onelogin.features.component.error.signin
...
import uk.gov.onelogin.features.error.ui.signin.SignInErrorAnalyticsViewModel
import uk.gov.onelogin.features.error.ui.signin.SignInErrorUnrecoverableScreen
import uk.gov.onelogin.features.error.ui.signin.SignInErrorUnrecoverableScreenPreview
import uk.gov.onelogin.features.error.ui.signin.SignInErrorUnrecoverableViewModel

@RunWith(AndroidJUnit4::class)
class SignInErrorUnrecoverableScreenTest : FragmentActivityTestCase() {
    private lateinit var analytics: AnalyticsLogger
    private lateinit var analyticsViewModel: SignInErrorAnalyticsViewModel
    private lateinit var viewModel: SignInErrorUnrecoverableViewModel
    ...
    fun setupNavigation() {
        ...
        viewModel = SignInErrorUnrecoverableViewModel()
    }
    ...
    fun verifyComponents() {
        ...
        verify(analytics).logEventV3Dot1(
            SignInErrorAnalyticsViewModel.Companion.makeUnrecoverableScreenEvent(context)
        )
    }
