 ...
 *
 * ** DO NOT use `unit` as that would clash with the autogenerated task that this is based off of.**
 */
...
project.afterEvaluate {
    ...
    extension.testTypes.get().forEach { testType ->
        ...
        android.libraryVariants.all {
            ...
            val taskName = "${testType}Test${variantName}Test"
            ...
            if (isDebug) {
                ...
                val jacocoReportTaskName = "jacoco${variantName}${testTypeCapitalised}TestReport"
